...
Lors de ce projet, nous allons vérifier si cette afirmation est également valable pour les sous-famille de fourmi. 
>>>>>>> 0adcf2019df4f45e7b6fd3b13a168e1cd8a4314a
...
```{r lin1}
ant_lm1 <- lm(data = ant, head_length ~ head_width * eye_length * eye_width - head_width:eye_width)
summary(ant_lm1) |> tabularise()
